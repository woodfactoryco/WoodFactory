/* Line icons (Feather Icons, MIT). Defined once here and pulled in
   by <Icon name="…" />, which renders <use href="#ic-…" />. */
export default function IconSprite() {
  return (
    <svg className="sprite" aria-hidden="true" focusable="false">
      ...
      {/* WhatsApp: chat bubble with a handset inside. The handset is the phone
          glyph scaled down, so its stroke-width is scaled back up to keep the
          same 1.8 visual weight as every other icon here. */}
      <symbol id="ic-whatsapp" viewBox="0 0 24 24">
        <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8z" />
        <g transform="translate(7.55 6.95) scale(0.375)">
          <path
            strokeWidth="4.8"
